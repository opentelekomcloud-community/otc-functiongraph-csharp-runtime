...
* Use the timer trigger preheating function.
  For detailed usage instructions, please refer to :otc_docs:`Using Timer Triggers <function-graph/umn/configuring_triggers/using_a_timer_trigger.html#functiongraph-01-0207>`.

* Use reserved instances to avoid cold starts. For detailed usage instructions, please refer to
  the :otc_docs:`Reserved Instance Management <function-graph/umn/configuring_reserved_instances.html>`
  section .