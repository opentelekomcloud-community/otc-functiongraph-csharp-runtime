...
Types of Building C# HTTP Functions
------------------------------------

You can build FunctionGraph HTTP functions in C# in the following ways:

* :ref:`From Scratch  <devguide_http_function_scratch_index>`
* :ref:`Using Container Image  <devguide_http_function_container_index>`

.. note::
  The option "Select template" is not supported for C# HTTP functions.
